...
There are situations where you might have a deeply nested hierarchy of classes all from a single Pydantic configuration.


Let's first consider our parent class which we visualise previously:
...
.. tabs::
   ...
   .. tab:: reST
      ...
      .. code-block:: rest
         ...
         .. automodule:: target.usage_inherited_models.ChildModel

   .. tab:: *rendered output*

      .. autopydantic_model:: target.usage_inherited_models.ChildModel

   .. tab:: python

      .. autocodeblock:: target.usage_inherited_models.ChildModel


With the default configuration an inherited class is visualised as follows:
...
.. tabs::
   ...
   .. tab:: reST
      ...
      .. code-block:: rest
         ...
         .. automodule:: target.usage_inherited_models.MultiParentChildModel

   .. tab:: *rendered output*

      .. autopydantic_model:: target.usage_inherited_models.MultiParentChildModel
         :inherited-members:

   .. tab:: python

      .. autocodeblock:: target.usage_inherited_models.MultiParentChildModel
...
.. tabs::
   ...
   .. tab:: reST
      ...
      .. code-block:: rest
         ...
         .. automodule:: target.usage_inherited_models.GrandChildModel

   .. tab:: *rendered output*

      .. autopydantic_model:: target.usage_inherited_models.GrandChildModel
         :inherited-members:

   .. tab:: python

      .. autocodeblock:: target.usage_inherited_models.GrandChildModel

It is clear that the inherited fields are not shown in the documentation. This is because the default configuration
of **autodoc_pydantic** is to only show the fields of the class that is being documented as a standard.
